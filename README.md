...
gmplus.js is a Google Maps Feature-rich Javascript wrapper that makes things like Marker filtering, asynchronous loading and animation much simpler with an easy-to-use API.
