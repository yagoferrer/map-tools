...
gmplus.js is a Google Maps Feature-rich Javascript wrapper that makes things like Marker filtering, asynchronous loading much simpler with an easy-to-use API.
