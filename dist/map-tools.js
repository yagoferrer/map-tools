...
},{"map-tools/index":10}],2:[function(require,module,exports){
...
},{"crossfilter":17}],3:[function(require,module,exports){
/*jslint node: true */
"use strict";
...
},{"map-tools/gmaps.js":8,"map-tools/utils":15}],4:[function(require,module,exports){
/*jslint node: true */
"use strict";
var utils = require('map-tools/utils');

module.exports = function (global, that) {
  var bubble = require('map-tools/bubble')(global);
  ...
  function addMarker(marker, options) {
    ...
    if (options && options.filters) {
      ...
      if (!global.GMP.maps[that.id].markers.filter) {
...
},{"map-tools/addFilter":2,"map-tools/bubble":5,"map-tools/utils":15}],5:[function(require,module,exports){
/*jslint node: true */
"use strict";
...
},{"map-tools/config":6,"map-tools/utils":15}],9:[function(require,module,exports){
/*jslint node: true */
"use strict";
var utils = require('map-tools/utils');
var config = require('map-tools/config');
...
},{"map-tools/config":6,"map-tools/findUpdateMarker":7,"map-tools/utils":15}],10:[function(require,module,exports){
/*jslint node: true */
"use strict";
module.exports = function (global) {
...
},{"map-tools/addMap":3,"map-tools/addMarker":4,"map-tools/groups":9,"map-tools/topojson":11,"map-tools/updateFeature":12,"map-tools/updateMap":13,"map-tools/updateMarker":14}],11:[function(require,module,exports){
/*jslint node: true */
"use strict";
...
},{"crossfilter":17,"map-tools/utils":15,"topojson":18}],12:[function(require,module,exports){
/*jslint node: true */
"use strict"
...
},{"map-tools/config":6,"map-tools/utils":15}],13:[function(require,module,exports){
"use strict";
module.exports = function (global, that) {
...
},{"map-tools/gmaps.js":8}],14:[function(require,module,exports){
/*jslint node: true */
"use strict";
var utils = require('map-tools/utils');
var config = require('map-tools/config');
...
},{"map-tools/config":6,"map-tools/findUpdateMarker":7,"map-tools/utils":15}],15:[function(require,module,exports){
/*jslint node: true */
"use strict";
...
},{"./crossfilter":16}],18:[function(require,module,exports){
!function() {
  var topojson = {
    version: "1.6.18",
