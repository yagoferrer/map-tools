...
module.exports = function (global, that) {
  ...
  function updateTag(marker, options) {
    if (options.custom.tag) {
      delete that.markers.tags[marker.tag][marker.data.uid];
      that.markers.tags[options.custom.tag] = that.markers.tags[options.custom.tag] || {};
      that.markers.tags[options.custom.tag][marker.data.uid] = marker;
      marker.tag = options.custom.tag;
    }
  }
