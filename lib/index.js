(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    define(['exports', 'gmplus'], factory);
  } else if (typeof exports === 'object') {
    // CommonJS
    factory(exports, require('gmplus'));
  } else {
    // Browser globals
    factory((root.commonJsStrict = {}), root.GMP);
  }

}(this, function (exports, gmplus) {
  ...
  function newMap(args, cb) {
    ...
    GMP.maps[args.id].instance = that.instance;
  ...
  function _addMarker(marker, options)
  {
    ...
    if (group && GMP.maps[that.id].groupOptions && GMP.maps[that.id].groupOptions[group]) {
      ...
      for (var i in GMP.maps[that.id].groupOptions[group]) {
        marker[i] = GMP.maps[that.id].groupOptions[group][i];
      }
    }
